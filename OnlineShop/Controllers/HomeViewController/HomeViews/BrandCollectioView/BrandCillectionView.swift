...
//MARK: - LIFECYCLE
    ...
    func configureAppearance() {
        ...
        register(BrandsCollectionViewCell.self, forCellWithReuseIdentifier: Resources.String.HomeController.categoryCollectionCell)
        delegate = self
        dataSource = self
    }
}
...
extension BrandsCollectionView: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: Resources.String.HomeController.categoryCollectionCell, for: indexPath) as! BrandsCollectionViewCell
        return cell
    }
