...
//MARK: - LIFECYCLE
    ...
    func configureAppearance() {
        ...
        register(CategoryCollectionViewCell.self, forCellWithReuseIdentifier: Resources.String.HomeController.categoryCollectionCell)
        delegate = self
        dataSource = self
    }
}
...
extension CategoryCollectionView: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: Resources.String.HomeController.categoryCollectionCell, for: indexPath) as! CategoryCollectionViewCell
