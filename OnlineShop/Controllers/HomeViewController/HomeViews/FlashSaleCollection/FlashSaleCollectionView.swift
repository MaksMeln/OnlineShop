...
//    }
    ...
    func configureAppearance() {
        ...
        register(FlashSaleColectionViewCell.self, forCellWithReuseIdentifier: Resources.String.HomeController.categoryCollectionCell)
        delegate = self
        dataSource = self
    }
}
...
//        return categoryArray.count
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: Resources.String.HomeController.categoryCollectionCell, for: indexPath) as! FlashSaleColectionViewCell
